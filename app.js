...
const puppeteer = require("puppeteer"); // to scrape data from a web page
const ora = require("ora");// displaying messages and a spinner on the terminal as we scrape the data
const chalk = require("chalk"); //displaying colorful messages
